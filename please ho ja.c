...
long long int uptwo,downtwo,upthree,downthree,t,n,l[10000000],o[10000000];
main()
{
    ...
    for(scanf("%lld",&t);t>0;t--)
    {
        ...
        for(i=1;i<=n;i++)
        {
            ...
            count=count+binary_search1(b,a[i],1,n);
            if(a[i]==2)
            {
                count=count+binary_search1(b,4,1,n);

            }

            if(a[i]==3)
            {
                count=count+binary_search1(b,2,1,n)-binary_search1(b,1,1,n);
                count=count+binary_search1(b,3,1,n);
            }
            if(b[i]==1)
                kl++;
            if(a[i]!=1)
